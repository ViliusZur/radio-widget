...
// displays a station using accordion item. When selected, the station expands showing plus, minus buttons and its' picture
const DisplayStation: React.FC<Props> = ({ station }) => (
  <AccordionItem
    ...
    <AccordionItemButton
      data-testid={`accordionBtn-${station.key}`}
